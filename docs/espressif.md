...
| 저장소 | ⭐ | 설명 |
|--------|----|------|
| [esp-idf](https://github.com/espressif/esp-idf) | 18,247 | Espressif 공식 IoT 개발 프레임워크(C/C++ SDK). idf.py·툴체인·FreeRTOS 포함 — 진단/CSI 펌웨어 빌드에 이미 사용 중 |
| [esptool](https://github.com/espressif/esptool) | 6,364 | 칩 펌웨어 flash·프로비저닝·칩/Flash 정보 조회 시리얼 유틸. 진단 도구 핵심 의존성 |
...
| [idf-extra-components](https://github.com/espressif/idf-extra-components) | 244 | ESP-IDF 추가 컴포넌트 모음 |
